		...
		<div class="flex flex-wrap">
			...
			<div class="basis-1/1 max-w-[100%] md:basis-1/2 md:max-w-[50%] flex-none md:pl-4 mt-6 md:mt-0">
				...
				<div class="box-button mb-6">
					...
					<button data-nonce="<?= wp_create_nonce('add_to_cart') ?>" data-product-id="<?= $id ?>" type="button" class="hidden btn-buy uppercase px-4 py-2 border-2 border-gray-900 text-gray-900 hover:bg-gray-900 hover:text-gray-100 duration-300 font-medium text-sm"><?php _e('Mua ngay', 'core'); ?><i class="fa-solid fa-money-check-dollar ml-2"></i></button>
					<button data-nonce="<?= wp_create_nonce('add_to_wishlist') ?>" class="btn btn-wish uppercase text-center px-4 py-2 border-2 border-gray-900 text-gray-900 hover:bg-gray-900 hover:text-gray-100 duration-300 font-medium mt-1 text-sm" data-product-id="<?= $id ?>" data-product-type="<?= esc_attr($product->get_type()); ?>" data-original-product-id="<?= ($product->get_parent_id()) ? esc_attr($product->get_parent_id()) : esc_attr($id) ?>" data-title="Wish list"><i class="fa-solid fa-heart"></i></button>
				</div>
